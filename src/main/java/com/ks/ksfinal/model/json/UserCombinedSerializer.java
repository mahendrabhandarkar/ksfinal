/*
package com.ks.ksfinal.model.json;
...
public class UserCombinedSerializer {
    public static class UserJsonSerializer extends JsonSerializer<Users> {

        @Override
        public void serialize(Users user, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
    ...
    public static class UserJsonDeserializer extends JsonDeserializer<Users> {
        @Override
        public Users deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
            ...
            return new Users(Color.web(favoriteColor.asText()));
        }
    }
}
